...
public class ToSubtract implements Mutation{
    ...
    public static void toEqual(Node node, int t){
        ...
        if(sonList == null || sonList.size() == 0){
            ...
            for (int i = 0; i < sonList.size(); i++) {
                ...
                if(cur.getNodeValue().indexOf("+") >= 0 && cur.getNodeName().indexOf("Statement") >= 0 && !cur.getNodeName().equals("CASTCompoundStatement") && t == 0 && cur.getNodeValue().indexOf("++") == -1){
